...
const ThreeApp = () => {
    //값을 변경하기 위해서는 useState 를 이용해서 선언
    //[변수명, setter 함수명] = useState(초기값)
    const [number,setNumber]=useState(0); // 0은 초기값값
    ...
    return (
        <div>
            <h3>ThreeApp 컴포넌트 - 숫자 증가/감소 이벤트트</h3>
