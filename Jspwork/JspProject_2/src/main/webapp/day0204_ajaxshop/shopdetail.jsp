     		...
     		$.ajax({
     			...
     			success:function(res){
                     ...
                     $.each(res, function(idx, item){
                         ...
                         s+= "<div class='reple-content'>" + item.message + "</div>";
                         s+= "</div>";
                         
                         s+=`<span class="close" idx="\${item.idx}"><i class="bi bi-x"></i></span>`;
                         s+="<br>";
                     });
	...
	<table class="table">
		...
		<tr>
			<td colspan="2">
				...
				<div class="replefrom input-group">
					...
					<input type="text" id="message" class="form-contrl"
					placeholder="상품평 쓰기" style="width:280px;">
