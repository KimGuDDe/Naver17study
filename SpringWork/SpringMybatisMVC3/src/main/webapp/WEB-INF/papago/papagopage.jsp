...
<html>
    ...
    <div style="margin: 20px;width: 600px;">
    	...
    	<div id="result" style="height: 200px;border: 1px solid black;margin-top: 20px;
    	font-size: 1.3em;"></div>
    </div>
    <script type="text/javascript">
    	$("#btntrans").click(function(){
    		let m = $("#message").val();
			let translang = $("#sellang").val();
			
    		$.ajax({    			
    			type:"post",
    			dataType:"json",
    			data:{"message":m,"lang":translang},
    			url:"./trans",
    			success:function(res){
    				console.log(res.text)
    				//json 모양의 문자열을 실제 json형태로 반환하기
