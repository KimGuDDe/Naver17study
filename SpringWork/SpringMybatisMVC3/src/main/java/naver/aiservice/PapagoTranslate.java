...
public class PapagoTranslate {
	...
	@ResponseBody
	public Map<String, String> trans(@RequestParam String message,
			@RequestParam String lang)
	{
		Map<String, String> map = new HashMap<>();

		String clientId = "45mk753uru";//애플리케이션 클라이언트 아이디값";
		String clientSecret = "SYtoslVfRQxSq6lAOnT1gcnaWhFPDwMwD6pFh98Q";//애플리케이션 클라이언트 시크릿값";
		try {
